...
describe('MaterialSystem', () => {
    ...
    describe('initialize()', () => {
        ...
        it('应该同时存储到配置系统', () => {
            ...
            const configData = configSystem.get<typeof testMaterials>(MATERIAL_CONFIG_KEY);
    ...
    describe('getMaterial()', () => {
        it('应该返回正确的材料数据', () => {
            ...
            expect(bamboo?.name).toBe('竹子');
            expect(bamboo?.type).toBe(MaterialType.RESOURCE);
            expect(bamboo?.rarity).toBe(MaterialRarity.COMMON);
        });
