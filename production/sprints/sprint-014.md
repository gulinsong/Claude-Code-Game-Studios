...
| ID | Task | Est. Days | Dependencies | Acceptance Criteria | Status |
|----|------|-----------|-------------|-------------------|--------|
| T5 | 商店资源制作 | 1 | — | 图标、截图、宣传图完成 | ✅ Done |
| T6 | 商店页面文案 | 0.5 | — | 描述、标签、关键词完成 | ✅ Done |
| T7 | 隐私政策和用户协议 | 0.5 | — | 法律文档准备完成 | ✅ Done |
...
**完成情况**:
- T5: 商店资源规格文档
  - 图标规格 (512x512, 192x192, 96x96)
  - 截图要求 (1280x720, 5张)
  - 宣传图规格 (1024x500)
  - 商店文案 (简短描述、详细描述、关键词)
  - 品牌色规范 (#4A7C59 主色, #D4A574 辅色)
  - 文件命名规范
  - 详见: `docs/release/store-assets-spec.md`
...
- T6: 商店文案
  ...
  - 详细描述 (核心玩法、游戏特色、适合人群)
  - 关键词和标签
  - 详见: `assets/store/documents/store_description.md`
- T7: 法律文档
  - 隐私政策 (信息收集、使用、存储、用户权利)
  - 用户协议 (账号使用、行为规范、知识产权、免责声明)
  - 详见: `assets/store/documents/privacy_policy.md`
  - 详见: `assets/store/documents/user_agreement.md`
